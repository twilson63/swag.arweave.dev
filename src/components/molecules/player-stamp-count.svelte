<script>
  ...
  let countRemaining = 12;
  let completed = stampList.length >= 3;
</script>
...
<div class="psc-wrapper">
  ...
  <div class="psc-d-container">
    ...
    <div class="psc-d-remaining-container">
      <p>Hoodies left:</p>
      &nbsp;
      <b>{countRemaining}</b>
    </div>
...
<style>
  ...
  .psc-d-remaining-container p {
    color: #ffffff;
    font-size: 14px;
    font-weight: 500;
  }
  .psc-d-remaining-container b {
    color: #ffffff;
    font-size: 14px;
    font-weight: 700;
  }
